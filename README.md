...
| ----------------------------------------------- | :--------------------: | :----------------------------: |
| Фоновая работа и фоновые задачи                 |        Доступно        |         **Ограничено**         |
| Автозапуск компонентов                          |        Возможно        |         **Ограничено**         |
| Взаимодействие с приложениями основного профиля |        Возможно        |         **Изолировано**        |
| Определение приложений на устройстве            |        Возможно        |   **Только рабочий профиль**   |
| Определение VPN                                 |        Возможно        |         **Скрывается**         |
...
| Доступ к фото и видео основного профиля         | При наличии разрешения |         **Изолировано**        |
| Доступ к контактам основного профиля            | При наличии разрешения |         **Изолировано**        |
| Камера и микрофон                               | При наличии разрешения | **Только с вашим разрешением** |
| Геолокация                                      | При наличии разрешения | **Только с вашим разрешением** |
