...
internal static class AndroidCommandIntentMapper
{
    ...
    public static string ToAction(AndroidCommandKind kind)
    {
        return kind switch
        {
            ...
            AndroidCommandKind.ClearLogs => AgnosiaActions.ClearLogs,
            ...
            AndroidCommandKind.QueryPackageState => AgnosiaActions.QueryPackageState,
            AndroidCommandKind.QueryAppPermissions => AgnosiaActions.QueryAppPermissions,
    ...
    public static bool TryFromAction(string? action, out AndroidCommandKind kind)
    {
        var resolved = action switch
        {
            ...
            AgnosiaActions.ClearLogs => AndroidCommandKind.ClearLogs,
            ...
            AgnosiaActions.QueryPackageState => AndroidCommandKind.QueryPackageState,
            AgnosiaActions.QueryAppPermissions => AndroidCommandKind.QueryAppPermissions,
