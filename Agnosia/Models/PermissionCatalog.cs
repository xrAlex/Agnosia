    ...
    private static readonly IReadOnlyDictionary<PermissionKind, PermissionDefinition> Definitions =
        new Dictionary<PermissionKind, PermissionDefinition>
        {
            ...
            [PermissionKind.UsageStats] = new(
                ...
                "Рабочий профиль",
                "Позволяет Agnosia понять, когда вы перестали использовать приложение, и заморозить его. В настройках Android выберите Agnosia в рабочем профиле и включите доступ к истории использования.",
                "Получено",
                "Открыть настройки"),
            [PermissionKind.Overlay] = new(
                "Поверх окон",
                "Основной профиль",
                "Нужно для отображения окна, которое позволяет запускать VPN после заморозки приложения в рабочем профиле. В настройках Agnosia в основном профиле включите «Поверх других приложений».",
                "Получено",
                "Открыть настройки")
        };
